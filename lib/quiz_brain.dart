...
class QuizBrain{
  ...
  List<Question> questions = [    Question('The Mahabharata is a part of The Bhagavad Gita', false),
  ...
  bool correctAnswer(bool userAnswer){
    return userAnswer == questions[questionNumber].ans;
  }
  nextQuestion (){
    questionNumber ++;
  }
